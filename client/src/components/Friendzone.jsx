...
const Friendzone = (props) => {
    const { customers, interests, user, friends } = props;
    return (
        <div>
            <h2>You are in the Friendzone!</h2>
            <div className="col-12 row">
            <h4 style={{textAlign: 'center'}}>My Friends:</h4>
                {friends.length > 0 ? friends.map((friend, i) => <Friend friend={friend} key={i} />) : "Well, this is awkward... It appears you don't have any friends."}
            </div>
